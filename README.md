...
**:zap::zap:Note: I don't have the full private plugin list here. If you want to know the full list (_+14 extra private plugins not listed here_), then contact with me.:zap::zap:**

* **DM weapons by time**: A gamemode based on DM FFA that change weapons type (pistols, snipers, rifles, SMG, shotguns, etc) every X time. Also included only HS every Y time. Ideal for practice with different weapons type.
